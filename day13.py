...
folds = []  # List of the folds to perform
max_x = 0
max_y = 0
...
for i, fold in enumerate(folds):
    # More general way to write this I guess but easier as there are just two directions
    if fold.direction == "y":
        ...
        # Zero out the "other" half
        for y_fold in range(fold.value, max_y+1):
            for x in range(max_x+1):
                input_as_matrix[y_fold][x] = 0
